...
export const ROUTE_NAMESPACES: Readonly<Record<string, readonly string[]>> = {
  ...
  '/~offline': [],
  '/collections': ['classificationNames', 'collections', 'dietary', 'recipe'],
  '/collections/:': [
    'classificationNames',
    'collections',
    'dietary',
  ...
  '/collections/:/print': [],
  '/cooks/:': ['classificationNames', 'collections', 'dietary', 'follows', 'recipe'],
  '/cooks/:/followers': ['follows'],
  '/cooks/:/following': ['follows'],
  '/design': [],
  '/discover': ['classificationNames', 'collections', 'dietary', 'recipe'],
  '/embed/recipes/:': [],
  '/groups': ['groups'],
  '/groups/:': ['groups'],
  ...
  '/recipes/:/:/print': ['print'],
  '/recipes/cook-with': ['classificationNames', 'collections', 'dietary', 'recipe'],
  '/recipes/new': [
    'billing',
    'classificationNames',
    'dietary',
