...
const a11yCss = readFileSync(join(process.cwd(), 'src/styles/a11y.css'), 'utf8').replace(/'/g, '"');
const globalsCss = readFileSync(join(process.cwd(), 'src/styles/globals.css'), 'utf8').replace(
  /'/g,
  '"',
);
