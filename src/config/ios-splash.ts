...
export function iosSplashFileName(device: IosSplashDevice, orientation: SplashOrientation): string {
...
export function iosSplashMedia(device: IosSplashDevice, orientation: SplashOrientation): string {
  return (
