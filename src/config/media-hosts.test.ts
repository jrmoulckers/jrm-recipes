...
describe('media host allowlist', () => {
  it('accepts Cloudinary and Clerk delivery hosts', () => {
    ...
    expect(isAllowedMediaUrl('https://res.cloudinary.com/demo/image/upload/x.jpg')).toBe(true);
  ...
  it('rejects off-allowlist hosts (tracking/beacon vector)', () => {
    ...
    expect(isAllowedMediaUrl('https://res.cloudinary.com.evil.example/x.jpg')).toBe(false);
  });
