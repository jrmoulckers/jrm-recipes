...
describe('isCloudinaryUrl', () => {
  ...
  it('rejects other hosts and delivery types', () => {
    ...
    expect(isCloudinaryUrl('https://res.cloudinary.com/heirloom/video/upload/v1/x.mp4')).toBe(
      false,
    );
  });
...
describe('cloudinaryLoader', () => {
  ...
  it('preserves the version and the full nested public id', () => {
    ...
    expect(out.startsWith('https://res.cloudinary.com/heirloom/image/upload/')).toBe(true);
  });
  ...
  it('only rewrites the first upload segment', () => {
    ...
    // the trailing path.
    const weird = 'https://res.cloudinary.com/heirloom/image/upload/v1/a-image-upload-b.jpg';
