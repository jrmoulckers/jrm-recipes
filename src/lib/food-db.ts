...
export const FOOD_ITEMS: FoodItem[] = [
  ...
  // --- Dairy -------------------------------------------------------------
  { name: "Milk", category: "dairy", densityGPerMl: 1.03, aliases: ["milk", "whole milk", "skim milk", "buttermilk"] },
  {
    name: "Cream",
    category: "dairy",
    densityGPerMl: 1.0,
    aliases: ["cream", "heavy cream", "double cream", "whipping cream", "sour cream", "half and half"],
  },
  {
    name: "Yogurt",
    category: "dairy",
  ...
  { name: "Brown sugar", category: "baking", densityGPerMl: 0.9, aliases: ["brown sugar"] },
  {
    name: "Powdered sugar",
    category: "baking",
    densityGPerMl: 0.5,
  ...
  { name: "Baking powder", category: "baking", densityGPerMl: 0.9, aliases: ["baking powder"] },
  {
    name: "Yeast",
    category: "baking",
    densityGPerMl: 0.7,
  ...
  },
  {
    ...
    category: "baking",
    densityGPerMl: 0.75,
    aliases: ["chocolate chips", "chocolate chip", "chocolate", "dark chocolate", "chocolate chunks"],
  },
  {
    name: "Breadcrumbs",
    category: "baking",
  ...
  // --- Dry goods / grains -----------------------------------------------
  {
    ...
    category: "grain",
    densityGPerMl: 0.85,
    aliases: ["rice", "white rice", "brown rice", "basmati rice", "jasmine rice", "arborio rice"],
  },
  {
    name: "Pasta",
    category: "dry-good",
    aliases: ["pasta", "spaghetti", "penne", "macaroni", "noodles", "fusilli", "linguine", "rigatoni"],
  },
  { name: "Oats", category: "grain", densityGPerMl: 0.41, aliases: ["oats", "rolled oats", "oatmeal", "quick oats"] },
  { name: "Quinoa", category: "grain", densityGPerMl: 0.85, aliases: ["quinoa"] },
  { name: "Couscous", category: "grain", densityGPerMl: 0.75, aliases: ["couscous"] },
  { name: "Cornmeal", category: "grain", densityGPerMl: 0.6, aliases: ["cornmeal", "polenta", "grits"] },
  { name: "Barley", category: "grain", densityGPerMl: 0.8, aliases: ["barley", "pearl barley"] },
  { name: "Bulgur", category: "grain", densityGPerMl: 0.72, aliases: ["bulgur", "bulghur", "cracked wheat"] },
  ...
  { name: "Chickpeas", category: "legume", densityGPerMl: 0.8, aliases: ["chickpeas", "garbanzo beans", "garbanzos"] },
  { name: "Lentils", category: "legume", densityGPerMl: 0.85, aliases: ["lentils", "red lentils", "green lentils"] },
  { name: "Peas", category: "legume", densityGPerMl: 0.72, aliases: ["peas", "split peas", "green peas"] },

  // --- Whole produce (count / weight) -----------------------------------
  { name: "Onion", category: "produce-whole", aliases: ["onion", "onions", "red onion", "yellow onion", "white onion"] },
  { name: "Garlic", category: "produce-whole", aliases: ["garlic", "garlic clove", "garlic cloves", "clove of garlic"] },
  { name: "Shallot", category: "produce-whole", aliases: ["shallot", "shallots"] },
  { name: "Potato", category: "produce-whole", aliases: ["potato", "potatoes"] },
  { name: "Sweet potato", category: "produce-whole", aliases: ["sweet potato", "sweet potatoes", "yam", "yams"] },
  { name: "Carrot", category: "produce-whole", aliases: ["carrot", "carrots"] },
  { name: "Tomato", category: "produce-whole", aliases: ["tomato", "tomatoes", "roma tomato", "cherry tomatoes"] },
  { name: "Bell pepper", category: "produce-whole", aliases: ["bell pepper", "bell peppers", "capsicum"] },
  { name: "Cucumber", category: "produce-whole", aliases: ["cucumber", "cucumbers"] },
  { name: "Zucchini", category: "produce-whole", aliases: ["zucchini", "courgette", "courgettes"] },
  { name: "Eggplant", category: "produce-whole", aliases: ["eggplant", "aubergine"] },
  { name: "Avocado", category: "produce-whole", aliases: ["avocado", "avocados"] },
  { name: "Mushroom", category: "produce-whole", aliases: ["mushroom", "mushrooms"] },
  { name: "Celery", category: "produce-whole", aliases: ["celery", "celery stalk", "celery stalks"] },
  { name: "Corn", category: "produce-whole", aliases: ["corn", "corn on the cob", "ear of corn", "corn cob"] },
  { name: "Broccoli", category: "produce-whole", aliases: ["broccoli"] },
  { name: "Cauliflower", category: "produce-whole", aliases: ["cauliflower"] },
  { name: "Squash", category: "produce-whole", aliases: ["squash", "butternut squash", "acorn squash", "pumpkin"] },
  { name: "Leek", category: "produce-whole", aliases: ["leek", "leeks"] },
  { name: "Ginger", category: "produce-whole", aliases: ["ginger", "fresh ginger", "ginger root"] },

  // --- Leafy produce -----------------------------------------------------
  { name: "Spinach", category: "produce-leafy", aliases: ["spinach", "baby spinach"] },
  { name: "Lettuce", category: "produce-leafy", aliases: ["lettuce", "romaine", "iceberg lettuce"] },
  { name: "Kale", category: "produce-leafy", aliases: ["kale"] },
  { name: "Cabbage", category: "produce-leafy", aliases: ["cabbage", "napa cabbage", "red cabbage"] },
  { name: "Arugula", category: "produce-leafy", aliases: ["arugula", "rocket"] },
  { name: "Chard", category: "produce-leafy", aliases: ["chard", "swiss chard"] },
  { name: "Salad greens", category: "produce-leafy", aliases: ["salad greens", "mixed greens", "greens"] },
  ...
  { name: "Berries", category: "produce-fruit", aliases: ["berries", "strawberries", "blueberries", "raspberries", "blackberries"] },
  { name: "Grapes", category: "produce-fruit", aliases: ["grapes"] },
  { name: "Mango", category: "produce-fruit", aliases: ["mango", "mangoes", "mangos"] },
  { name: "Pineapple", category: "produce-fruit", aliases: ["pineapple"] },
  { name: "Peach", category: "produce-fruit", aliases: ["peach", "peaches"] },
  { name: "Raisins", category: "produce-fruit", aliases: ["raisins", "sultanas", "dried cranberries", "currants"] },

  // --- Herbs -------------------------------------------------------------
  { name: "Basil", category: "herb", aliases: ["basil", "fresh basil"] },
  { name: "Parsley", category: "herb", aliases: ["parsley", "fresh parsley", "flat leaf parsley"] },
  { name: "Cilantro", category: "herb", aliases: ["cilantro", "coriander leaves", "fresh coriander"] },
  { name: "Mint", category: "herb", aliases: ["mint", "fresh mint"] },
  { name: "Thyme", category: "herb", aliases: ["thyme", "fresh thyme"] },
  { name: "Rosemary", category: "herb", aliases: ["rosemary", "fresh rosemary"] },
  ...
  // --- Spices ------------------------------------------------------------
  { name: "Salt", category: "spice", densityGPerMl: 1.2, aliases: ["salt", "sea salt", "kosher salt", "table salt"] },
  { name: "Black pepper", category: "spice", aliases: ["black pepper", "pepper", "ground pepper", "peppercorns"] },
  { name: "Cinnamon", category: "spice", aliases: ["cinnamon", "ground cinnamon"] },
  { name: "Cumin", category: "spice", aliases: ["cumin", "ground cumin"] },
  { name: "Paprika", category: "spice", aliases: ["paprika", "smoked paprika"] },
  { name: "Chili powder", category: "spice", aliases: ["chili powder", "chilli powder", "cayenne", "cayenne pepper"] },
  { name: "Turmeric", category: "spice", aliases: ["turmeric", "ground turmeric"] },
  { name: "Nutmeg", category: "spice", aliases: ["nutmeg", "ground nutmeg"] },
  { name: "Ground ginger", category: "spice", aliases: ["ground ginger", "ginger powder"] },
  { name: "Curry powder", category: "spice", aliases: ["curry powder", "garam masala"] },
  { name: "Garlic powder", category: "spice", aliases: ["garlic powder", "onion powder"] },
  { name: "Vanilla", category: "spice", aliases: ["vanilla", "vanilla extract", "vanilla essence"] },
  { name: "Cloves", category: "spice", aliases: ["cloves", "ground cloves"] },
  { name: "Ground coriander", category: "spice", aliases: ["ground coriander", "coriander seed", "coriander seeds"] },
  { name: "Red pepper flakes", category: "spice", aliases: ["red pepper flakes", "crushed red pepper", "chili flakes"] },

  // --- Meat --------------------------------------------------------------
  { name: "Chicken", category: "meat", aliases: ["chicken", "chicken breast", "chicken thigh", "chicken thighs", "chicken breasts"] },
  { name: "Beef", category: "meat", aliases: ["beef", "ground beef", "steak", "beef mince", "minced beef", "brisket"] },
  { name: "Pork", category: "meat", aliases: ["pork", "pork chop", "pork chops", "ground pork", "pork belly", "pork shoulder"] },
  { name: "Bacon", category: "meat", aliases: ["bacon", "bacon strips", "pancetta"] },
  { name: "Sausage", category: "meat", aliases: ["sausage", "sausages", "chorizo"] },
  { name: "Turkey", category: "meat", aliases: ["turkey", "ground turkey", "turkey breast"] },
  { name: "Lamb", category: "meat", aliases: ["lamb", "ground lamb", "lamb chops"] },
  { name: "Ham", category: "meat", aliases: ["ham", "prosciutto"] },

  // --- Seafood -----------------------------------------------------------
  { name: "Fish", category: "seafood", aliases: ["fish", "salmon", "tuna", "cod", "tilapia", "haddock", "fish fillet"] },
  { name: "Shrimp", category: "seafood", aliases: ["shrimp", "prawns", "prawn"] },
  { name: "Scallops", category: "seafood", aliases: ["scallops", "scallop"] },
  { name: "Crab", category: "seafood", aliases: ["crab", "crab meat", "crabmeat"] },
  { name: "Mussels", category: "seafood", aliases: ["mussels", "clams"] },

  // --- Eggs --------------------------------------------------------------
  { name: "Egg", category: "egg", aliases: ["egg", "eggs", "large egg", "large eggs"] },
  { name: "Egg white", category: "egg", densityGPerMl: 1.03, aliases: ["egg white", "egg whites"] },
  { name: "Egg yolk", category: "egg", densityGPerMl: 1.03, aliases: ["egg yolk", "egg yolks", "yolk", "yolks"] },

  // --- Fats & oils -------------------------------------------------------
  { name: "Butter", category: "fat-oil", densityGPerMl: 0.96, aliases: ["butter", "unsalted butter", "salted butter", "margarine"] },
  {
    name: "Oil",
    category: "fat-oil",
    densityGPerMl: 0.92,
    aliases: ["oil", "olive oil", "vegetable oil", "canola oil", "sunflower oil", "sesame oil", "coconut oil"],
  },
  { name: "Shortening", category: "fat-oil", densityGPerMl: 0.88, aliases: ["shortening", "lard", "ghee"] },

  // --- Sweeteners --------------------------------------------------------
  { name: "Honey", category: "sweetener", densityGPerMl: 1.42, aliases: ["honey"] },
  { name: "Maple syrup", category: "sweetener", densityGPerMl: 1.37, aliases: ["maple syrup", "syrup"] },
  { name: "Molasses", category: "sweetener", densityGPerMl: 1.4, aliases: ["molasses", "treacle"] },
  { name: "Corn syrup", category: "sweetener", densityGPerMl: 1.38, aliases: ["corn syrup", "golden syrup", "agave", "agave nectar"] },
  ...
  // --- Nuts & seeds ------------------------------------------------------
  {
    ...
    category: "nut-seed",
    densityGPerMl: 0.5,
    aliases: ["nuts", "almonds", "walnuts", "pecans", "cashews", "hazelnuts", "pistachios", "peanuts", "pine nuts"],
  },
  { name: "Peanut butter", category: "nut-seed", densityGPerMl: 1.09, aliases: ["peanut butter", "almond butter", "nut butter", "tahini"] },
  {
    name: "Seeds",
    category: "nut-seed",
    densityGPerMl: 0.55,
    aliases: ["seeds", "sunflower seeds", "pumpkin seeds", "sesame seeds", "chia seeds", "flax seeds", "flaxseed"],
  },
  { name: "Shredded coconut", category: "nut-seed", densityGPerMl: 0.35, aliases: ["shredded coconut", "desiccated coconut", "coconut flakes"] },

  // --- Condiments --------------------------------------------------------
  { name: "Soy sauce", category: "condiment", densityGPerMl: 1.15, aliases: ["soy sauce", "tamari"] },
  { name: "Vinegar", category: "condiment", densityGPerMl: 1.01, aliases: ["vinegar", "balsamic vinegar", "apple cider vinegar", "rice vinegar", "white vinegar"] },
  { name: "Ketchup", category: "condiment", densityGPerMl: 1.1, aliases: ["ketchup", "catsup", "tomato ketchup"] },
  { name: "Mustard", category: "condiment", densityGPerMl: 1.05, aliases: ["mustard", "dijon mustard", "wholegrain mustard"] },
  { name: "Mayonnaise", category: "condiment", densityGPerMl: 0.91, aliases: ["mayonnaise", "mayo"] },
  { name: "Tomato paste", category: "condiment", densityGPerMl: 1.1, aliases: ["tomato paste", "tomato puree", "tomato sauce", "passata"] },
  { name: "Hot sauce", category: "condiment", densityGPerMl: 1.02, aliases: ["hot sauce", "sriracha", "tabasco"] },
  { name: "Worcestershire sauce", category: "condiment", densityGPerMl: 1.1, aliases: ["worcestershire sauce", "worcestershire", "fish sauce"] },
];
