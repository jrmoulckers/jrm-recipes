...
export const FOOD_ITEMS: FoodItem[] = [
  ...
  { name: 'Orange', category: 'produce-fruit', aliases: ['orange', 'oranges'] },
  {
    ...
    aliases: ['berries', 'strawberries', 'blueberries', 'raspberries', 'blackberries'],
  },
  ...
  // --- Meat --------------------------------------------------------------
  {
    name: 'Chicken',
    category: 'meat',
    aliases: ['chicken', 'chicken breast', 'chicken thigh', 'chicken thighs', 'chicken breasts'],
  },
  {
    name: 'Beef',
    category: 'meat',
    aliases: ['beef', 'ground beef', 'steak', 'beef mince', 'minced beef', 'brisket'],
  },
  {
    name: 'Pork',
    category: 'meat',
    aliases: ['pork', 'pork chop', 'pork chops', 'ground pork', 'pork belly', 'pork shoulder'],
  },
  {
    name: 'Bacon',
    category: 'meat',
  ...
  // --- Seafood -----------------------------------------------------------
  {
    name: 'Fish',
    category: 'seafood',
    aliases: ['fish', 'salmon', 'tuna', 'cod', 'tilapia', 'haddock', 'fish fillet'],
  },
  {
    name: 'Shrimp',
    category: 'seafood',
...
export function foodCategoryForItem(item: string | null | undefined): FoodCategory | null {
 ...
 */
export function canonicalFood(item: string | null | undefined): CanonicalFood | null {
