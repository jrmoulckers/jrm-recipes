...
const HEAT_KEYWORDS = [
  ...
  "stove", "stovetop", "burner", "burners",
  "microwave", "microwaves", "microwaved",
  "caramelize", "caramelizes", "caramelized", "caramelizing",
  "deglaze", "deglazes", "deglazed", "deglazing",
  "braise", "braises", "braised", "braising",
  "sizzle", "sizzles", "sizzling",
  "scorch", "scorches", "scorched", "scorching",
  "torch", "torches", "flame", "flames",
] as const;
...
const SHARP_KEYWORDS = [
  ...
  "grate", "grates", "grated", "grating", "grater", "graters",
  "julienne", "juliennes", "julienned",
  "zest", "zests", "zested", "zesting", "zester", "zesters",
...
> = {
  ...
  sharp: {
    ...
    label: "Safety warning: this step uses something sharp. Ask a grown-up to help.",
  },
};
