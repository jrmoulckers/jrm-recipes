 ...
 */
export function parseJournalRange(value: string | string[] | undefined | null): JournalRange {
 ...
 */
export function journalRangeSince(range: JournalRange, now: Date = new Date()): Date | null {
  switch (range) {
    case 'month':
