...
export type Allergen =
  'peanut' | 'tree-nut' | 'dairy' | 'egg' | 'soy' | 'wheat' | 'fish' | 'shellfish' | 'sesame';
 ...
 */
export function detectHiddenAllergens(item: string | null | undefined): HiddenAllergenWarning[] {
 ...
 */
export function summarizeHiddenAllergens(items: string[]): HiddenAllergenWarning[] {
 ...
 */
export function detectAllergensForSafety(item: string | null | undefined): Allergen[] {
