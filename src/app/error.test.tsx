...
describe('app error boundary', () => {
  ...
  it('does not leak the raw error message or stack to the UI', () => {
    render(<ErrorBoundary error={new Error('SUPER_SECRET_INTERNAL_DETAIL')} reset={vi.fn()} />);
    expect(screen.queryByText(/SUPER_SECRET_INTERNAL_DETAIL/)).not.toBeInTheDocument();
  });
