...
import { EmptyLibraryCta, EMPTY_LIBRARY_CTA_FLAG, emptyLibraryCopy } from './empty-library-cta';
...
describe('emptyLibraryCopy', () => {
  ...
  it('maps known variants to their copy', () => {
    expect(emptyLibraryCopy('benefit').heading).toBe("Save your family's first recipe");
  });
});
