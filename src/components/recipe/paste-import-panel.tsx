 ...
 * /recipes/[cook]/[recipe]/edit first-load JS budget.
 */
export function PasteImportPanel({ onImported }: { onImported: (recipe: ImportedRecipe) => void }) {
  ...
  return (
    <>
      <p className="mt-3 text-sm text-muted-foreground">{t('import.textHelp')}</p>
