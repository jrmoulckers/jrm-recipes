...
const dialogContentVariants = cva(
  "fixed left-1/2 top-1/2 z-50 grid max-h-[calc(100dvh-2rem)] w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 overflow-y-auto data-[state=open]:animate-pop-in data-[state=closed]:animate-pop-out",
  {
    variants: {
