...
describe('Button focus-visible indicator', () => {
  ...
  it.each(['default', 'secondary', 'accent', 'outline', 'ghost', 'destructive', 'link'] as const)(
    'keeps the focus ring on the %s variant',
    (variant) => {
...
describe('Button data-variant hook (issue #131)', () => {
  ...
  it.each(['secondary', 'accent', 'outline', 'ghost', 'destructive', 'link'] as const)(
    'reflects the %s variant on the element',
    (variant) => {
