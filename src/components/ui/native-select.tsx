    ...
    return (
      <div className={cn('relative w-full', wrapperClassName)}>
        <select
          ref={ref}
          className={cn(
            'flex h-11 w-full appearance-none rounded-lg border border-input bg-background py-2 ps-3.5 pe-10 text-base shadow-token-sm transition-colors focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-hidden disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
        ...
        <ChevronDown
          className="pointer-events-none absolute inset-e-3.5 top-1/2 size-4 -translate-y-1/2 opacity-60"
          aria-hidden="true"
        />
      </div>
    );
