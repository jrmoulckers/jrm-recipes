...
describe('InstallPrompt modal dialog semantics', () => {
  ...
  it('is a labelled modal dialog wired to real title/description ids', async () => {
    ...
    expect(document.getElementById(labelledBy!)).toHaveTextContent(/install heirloom/i);
    expect(document.getElementById(describedBy!)).toHaveTextContent(/home screen/i);
  });
