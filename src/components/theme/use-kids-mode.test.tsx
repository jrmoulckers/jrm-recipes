...
import { type A11yPrefs, A11Y_COOKIE, A11Y_PREVIOUS_COOKIE, DEFAULT_A11Y } from '~/config/a11y';
...
beforeEach(() => {
  localStorage.clear();
  for (const name of [THEME_COOKIE, THEME_PREVIOUS_COOKIE, A11Y_COOKIE, A11Y_PREVIOUS_COOKIE]) {
