...
export function FavoriteButton({
  ...
  return (
    <button
      ...
      title={label}
      className={cn(
        'inline-flex size-9 items-center justify-center rounded-full border border-border bg-card/80 text-muted-foreground shadow-token backdrop-blur-sm transition-[color,transform] duration-150 hover:scale-105 hover:text-primary focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-hidden motion-reduce:transition-none',
