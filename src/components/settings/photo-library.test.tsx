...
const { deleteAssetAction, getAssetUsageAction, listAssetsAction, updateAltTextAction } =
  vi.hoisted(() => ({
...
describe('PhotoLibrary', () => {
  ...
  it('loads usage only for delete and names the photo and visible uses', async () => {
    ...
    expect(within(dialog).getByText('¿Eliminar «Pan de plátano»?')).toBeInTheDocument();
