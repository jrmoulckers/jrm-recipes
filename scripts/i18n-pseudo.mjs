...
function main() {
  ...
  const source = JSON.parse(readFileSync(resolve(messagesDir, `${defaultLocale}.json`), 'utf8'));
  ...
  if (check) {
    ...
    if (current !== generated) {
      console.error(`i18n: pseudolocale at ${outPath} is stale. Run \`pnpm i18n:pseudo\`.`);
      process.exit(1);
    }
