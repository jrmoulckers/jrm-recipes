...
keep cooking week over week? This doc also explains how to reproduce the cohort curves and table
...
denominator = users in the signup-week cohort. The numerator is those with ≥1
